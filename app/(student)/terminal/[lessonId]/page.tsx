...
import { StudentTerminalLayout } from "@/components/lesson/StudentTerminalLayout"
...
export default function TerminalPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center space-y-4">
          <Loader2 className="h-12 w-12 animate-spin text-indigo-600 mx-auto" strokeWidth={1.5} />
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Lesson ID: <code className="text-indigo-600">{lessonId}</code>
              </p>
            </div>
          </div>
        </Card>
  ...
  return <StudentTerminalLayout lesson={lesson} />
}
