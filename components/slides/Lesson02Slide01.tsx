/**
 * Lesson 02 - Slide 01: Title Card
 * Operation Chronos: Memory Containers
 */

import React from 'react';
import { Database, Save, HardDrive } from 'lucide-react';

export function Lesson02Slide01() {
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-cyan-950 via-blue-950 to-slate-950 text-white flex items-center justify-center p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center space-y-8">
                ...
                <div className="flex justify-center gap-8 mb-8">
                    ...
                    <HardDrive className="w-16 h-16 text-[#53d22d]" />
                    <Save className="w-16 h-16 text-cyan-400 animate-pulse" />
                </div>
